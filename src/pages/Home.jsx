        ...
        <FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div className="md:col-span-5 flex flex-col justify-end gap-4">
              <a href="mailto:jimcipriani@gmail.com" className="flex items-center gap-3 group">
...
export default function Home() {
  usePageMeta({
    title: 'Cipriani Design',
    description:
      'Jim Cipriani — AI-first product designer, thinker, and builder. I design web and mobile products for startup and growth technology ventures.',
